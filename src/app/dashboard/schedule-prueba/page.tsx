...
const ScheduleTable: React.FC = () => {
  ...
  return (
    <div className="container mx-auto mt-48 mb-10 p-4">
      <div className="mb-6">
      ...
      {message && <div className="mb-4 text-lg text-black-600">{message}</div>}
        ...
        <table className="w-full sm:w-11/12 md:w-8/12 table-auto border-collapse border border-gray-300">
          ...
          <tbody>
            {hours.map((hour, hourIndex) => (
              <tr key={hourIndex}>
                <td className="p-3 text-xs sm:text-base border border-gray-300 bg-blue-50 text-center whitespace-nowrap w-1/6">
                  {hour}
                </td>
                {days.map((_, dayIndex) => {
                  ...
                  return (
                    <td
                      key={dayIndex}
                      className={`p-3 border border-gray-300 text-center cursor-pointer text-xs sm:text-base ${isSelected ? "bg-blue-300" : "bg-blue-50"
                        }`}
