...
const [openUnits, setOpenUnits] = useState<{ [key: number]: boolean }>({
    1: true, // Por defecto, la Unidad de Competencia 1 está abierta
});

const toggleOpen = (index: number) => {
    setOpenUnits((prev) => ({
    ...prev,
    [index]: !prev[index], // Cambiar el estado de la unidad seleccionada
    }));
};

    return (
    <>
        <section className="pb-[60px] pt-[70px]">
            ...
            <div className="-mx-4 flex flex-wrap justify-center">
                ...
                <div>
                    ...
                    <div className="absolute left-[-11px] top-2 w-5 h-5 rounded-full border-4 bg-white z-10 border-blue-500">
                        {openUnits[1] && <div className="w-full h-full bg-blue-500 rounded-full" />}
                    </div>
                    <div
                        className={`cursor-pointer border ${openUnits[1] ? "border-blue-500" : "border-gray-300"} rounded-md p-4 mt-1`}
                    ...
                    <div className="absolute left-[-11px] top-2 w-5 h-5 rounded-full border-4 bg-white z-10 border-blue-500">
                        {openUnits[2] && <div className="w-full h-full bg-blue-500 rounded-full" />}
                    </div>
                    <div
                        className={`cursor-pointer border ${openUnits[2] ? "border-blue-500" : "border-gray-300"} rounded-md p-4 mt-1`}
                    ...
                    {/* Imagen de perfil */}
                    <div className="mb-10 w-full overflow-hidden rounded pt-12">
